...
const artecal=document.querySelector('.lorem-text')
const amunt=document.getElementById('amunt')

// console.log(form);
form.addEventListener('submit',function (e) {
e.preventDefault();
const value=parseInt(amunt.value)
...
if (isNaN(value)||value<0||value>9) {
  ...
  artecal.innerHTML=`<p class="result">${text[randomNum]}</p>`
